...
<ul>
{% for prof in site.data.experiences %}
 <li> <font size="+1">{{ prof.name }}</font> <br/> {{prof.date}} <br/> {{prof.description}} </li>
{% endfor %}
</ul>
</div>
{% endif %}

{% if site.data.volunteer %}
<div class="jumbotron">
### Volunteering Experience
<ul>
{% for prof in site.data.volunteer %}
 <li> <font size="+1">{{ prof.name }}</font> <br/> {{prof.date}} <br/> </li>
{% endfor %}
</ul>
</div>
{% endif %}